...
// Element Dictionary
export const getElementDict = (state: RootState): ElementDict => state.data.svg.elementDict;
...
export const getSelectedElement = (state: RootState): BaseElement | undefined => {
